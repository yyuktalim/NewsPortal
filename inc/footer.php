                        ...
                        <div class="single-footer-caption">
                            <div class="single-footer-caption">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="assets/assets/img/logo/logo2_footer.png" alt=""></a>
                                </div>
                                ...
                                <div class="footer-form" >
                                    <div id="mc_embed_signup">
                                        ...
                                        method="get" class="subscribe_form relative mail_part">
                                            ...
                                            class="email_icon newsletter-submit button-contactForm"><img src="assets/assets/img/logo/form-iocn.png" alt=""></button>
                                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6">
                        <div class="single-footer-caption mb-50 mt-60">
                            ...
                            <div class="instagram-gellay">
                                <ul class="insta-feed">
                                    <li><a href="#"><img src="assets/assets/img/post/instra1.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="assets/assets/img/post/instra2.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="assets/assets/img/post/instra3.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="assets/assets/img/post/instra4.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="assets/assets/img/post/instra5.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="assets/assets/img/post/instra6.jpg" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<!-- JS here -->
        ...
        <!-- Date Picker -->
        <script src="./assets/assets/js/gijgo.min.js"></script>
		<!-- One Page, Animated-HeadLin -->
        <script src="./assets/assets/js/wow.min.js"></script>
		<script src="./assets/assets/js/animated.headline.js"></script>
        <script src="./assets/assets/js/jquery.magnific-popup.js"></script>

        <!-- Breaking New Pluging -->
        <script src="./assets/assets/js/jquery.ticker.js"></script>
        ...
        <script src="./assets/assets/js/mail-script.js"></script>
